...
/
prompt --application/shared_components/plugins/region_type/apex_hello_world
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(11523524889212251690)
,p_plugin_type=>'REGION TYPE'
,p_name=>'APEX.HELLO.WORLD'
,p_display_name=>'1. APEX Hello World Plug-in'
...
'    HTP.HEADER(1,''Build with love using APEX!'');',
'    /* think always about security and use escaping or sanitizing features */',
'    HTP.P(APEX_ESCAPE.HTML(''<script>alert("This plug-in has no problem with XSS :-)");</script>''));',
'',
'    RETURN VR_RESULT;',
'END;'))
,p_api_version=>2
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(11523525167941251692)
,p_plugin_id=>wwv_flow_api.id(11523524889212251690)
,p_file_name=>'LICENSE'
